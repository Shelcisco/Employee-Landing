...
export default function Bs() {
  ...
  return (
    ...
    <div className="best">
      ...
      <button className="FavButt" alt="Bs-Butt" onClick={() => addToFavorites("Bs")}>
        Add to Favorites
      </button>
